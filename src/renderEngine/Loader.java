...
public class Loader {
	...
	//The more negative, the sharper the textures
	private static float TEXTURE_LOD_BIAS = -0.4f;
	...
	public int loadTexture(String fileName) {
		...
		try {
			...
			GL11.glTexParameterf(GL11.GL_TEXTURE_2D, GL14.GL_TEXTURE_LOD_BIAS, TEXTURE_LOD_BIAS);
